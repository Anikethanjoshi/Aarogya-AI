...
import { Heart, User, Settings, Menu, X, Globe, LogOut } from 'lucide-react'
        ...
        {isMenuOpen && (
          <div className="md:hidden border-t border-gray-200 py-4">
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              ...
              <button
                onClick={toggleLanguage}
                className="flex items-center space-x-2 px-3 py-2 text-base font-medium text-gray-700 hover:text-primary-600 w-full"
              >
                <Globe className="h-5 w-5" />
